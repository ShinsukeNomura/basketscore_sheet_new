...
export const AI_REPORT_PDF_STYLE = `
  ...
  .sheet-ai .ai-p { margin: 0 0 0.5mm; break-inside: avoid; }
  .sheet-ai .ai-ul { margin: 0 0 0.6mm; padding-left: 3mm; break-inside: avoid; }
  .sheet-ai .ai-ul li { margin-bottom: 0.15mm; }
`;
